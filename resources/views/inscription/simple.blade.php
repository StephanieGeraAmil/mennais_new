        ...
        <div class="u-layout-col">
            ...
            <div class="u-layout-col">
              <div class="u-align-center u-container-align-center u-container-style u-layout-cell u-palette-2-base u-size-60 u-layout-cell-1">
                <div class="u-container-layout u-valign-middle u-container-layout-1">
                  <h5 class="u-align-center u-text u-text-default u-text-1">Error de inscripción</h5>
                </div>
              </div>
            </div>
          </div>
          <div class="u-size-30">
            <div class="u-layout-row">
              <div class="u-container-align-center-lg u-container-align-center-md u-container-align-center-sm u-container-align-center-xl u-container-style u-layout-cell u-opacity u-opacity-85 u-shape-rectangle u-size-30 u-layout-cell-2">
                <div class="u-container-layout u-container-layout-2">
                  <h4 class="u-align-center u-text u-text-white u-text-2">INSCRIPCIÓN INDIVIDUAL</h4>
                  <div class="u-border-2 u-border-palette-1-light-1 u-container-align-center-xl u-container-style u-expanded-width u-group u-opacity u-opacity-70 u-radius-22 u-shape-round u-white u-group-1">
                    <div class="u-container-layout u-valign-middle-xl u-container-layout-3">
                      <p class="u-align-center u-text u-text-3">Por favor, complete y envíe el formulario con sus datos</p>
                    </div>
                  </div>
                </div>
              </div>
              <div class="u-container-align-center u-container-style u-layout-cell u-opacity u-opacity-85 u-shape-rectangle u-size-30 u-layout-cell-3">
                <div class="u-container-layout u-valign-middle u-container-layout-4">
                  <div class="u-align-center u-form u-form-1">
                    <form action="#" class="u-clearfix u-form-spacing-12 u-form-vertical u-inner-form" source="custom" name="Inscripción Individual" style="padding: 18px;" method="post">
                      <div class="u-form-group u-form-name">
                        <label for="name-05a8" class="u-form-control-hidden u-label"></label>
                        <input type="text" placeholder="Nombre" id="name-05a8" name="name" class="u-input u-input-rectangle u-radius-14 u-input-1" required="">
                      </div>
                      <div class="u-form-group u-form-group-2">
                        <label for="text-8cb6" class="u-form-control-hidden u-label"></label>
                        <input type="text" placeholder="Apellido" id="text-8cb6" name="lastname" class="u-input u-input-rectangle u-radius-14 u-input-2">
                      </div>
                      <div class="u-form-group u-form-name u-form-group-3">
                        <label for="name-b2b6" class="u-form-control-hidden u-label"></label>
                        <input type="text" placeholder="Cédula de Identidad (1234567-8)" id="name-b2b6" name="document" class="u-input u-input-rectangle u-radius-14 u-input-3" required="">
                      </div>
                      <div class="u-form-email u-form-group">
                        <label for="email-05a8" class="u-form-control-hidden u-label"></label>
                        <input type="email" placeholder="email" id="email-05a8" name="email" class="u-input u-input-rectangle u-radius-14 u-input-4" required="">
                      </div>
                      ...
                      <div class="u-form-group u-form-group-6">
                        ...
                        <input type="text" placeholder="Institución" id="text-59c6" name="institution_name" class="u-input u-input-rectangle u-radius-14 u-input-6">
                      </div>
                      ...
                      <div class="u-form-group u-form-group-8">
                        ...
                        <input type="text" placeholder="Ciudad" id="text-8b97" name="city" class="u-input u-input-rectangle u-radius-14 u-input-8">
                      </div>
                      <div class="u-form-group u-form-group-9">
                        <label for="text-1207" class="u-form-control-hidden u-label"></label>
                        <input type="text" placeholder="Monto depositado" id="text-1207" name="amount" class="u-input u-input-rectangle u-radius-14 u-input-9">
                      </div>
                      <div class="u-form-group u-form-group-10">
                        <label for="text-c55e" class="u-form-control-hidden u-label"></label>
                        <input type="text" placeholder="Botón" id="text-c55e" name="payment_file" class="u-input u-input-rectangle u-radius-14 u-input-10">
                      </div>
                      <div class="u-align-right u-form-group u-form-submit">
                        <a href="#" class="custom-page-typo-item u-active-custom-color-22 u-border-2 u-border-active-palette-1-light-2 u-border-hover-palette-1-dark-1 u-border-palette-1-dark-1 u-btn u-btn-submit u-button-style u-hover-palette-1-dark-1 u-palette-1-light-3 u-btn-1" data-animation-name="" data-animation-duration="0" data-animation-delay="0" data-animation-direction="">enviar<br>
                        </a>
                        <input type="submit" value="submit" class="u-form-control-hidden">
                      </div>
                      <div class="u-form-send-message u-form-send-success">Gracias por inscribirse !
Le llegará por mail la confirmación de su inscripción.</div>
                      <div class="u-form-send-error u-form-send-message">No ha sido posible realizar la inscripción.</div>
