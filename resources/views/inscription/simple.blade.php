...
Por favor, complete el formulario con sus datos.<br/>
El miércoles 28 de setiembre cada participante podrá visitar dos colegios.<br/>
Seleccione la institución que desee visitar en cada turno.<br/>
Sólo se mostrarán los colegios con cupos disponibles.<br/>
@endsection
@section('form')
