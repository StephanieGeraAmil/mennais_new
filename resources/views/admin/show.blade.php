                                ...
                                <form action="/admin/user_data/{{$inscription->userData->id}}" method="POST" class="u-clearfix u-form-spacing-10 u-form-vertical u-inner-form" source="customphp" name="form" style="padding: 10px;">
                                    ...
                                    <div class="flex items-center border-b py-2 w-100">
                                        <select id="type" name="type" class="u-border-2 u-border-grey-5 u-grey-5 u-input u-input-rectangle u-radius-10">
                                            <option value="virtual" {{(old('type')??$inscription->type->value =="virtual")?"Selected":""}}>{{App\Enums\InscriptionTypeEnum::REMOTO->text()}}</option>
                                            <option value="hibrido" {{(old('type')??$inscription->type->value =="hibrido")?"Selected":""}}>{{App\Enums\InscriptionTypeEnum::HIBRIDO->text()}}</option>
                                        </select>                           
                                    </div>
                                    <div class="">
                                        <div class="pt-3">
